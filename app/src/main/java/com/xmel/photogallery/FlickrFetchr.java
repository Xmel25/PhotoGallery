...
public class FlickrFetchr {
    ...
    public static final String API_KEY = "c84aa98bbd79eebdbdd6c760cdfbd15c";
    public static final String METHOD_GET_REST = "flickr.photos.getRecent";
    ...
    public ArrayList<GalleryItem> downloadGalleryItems(String url) {
        ...
        try {
            ...
            Log.d(TAG, "Failed to recieve xml", e);
    ...
    public ArrayList<GalleryItem> fetchItems() {
        String url = Uri.parse(ENDPOINT).buildUpon()
                .appendQueryParameter("method", METHOD_GET_REST)
